  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden bg-zinc-950">
        ...
        <div className="flex items-center gap-2">
          <div className="relative w-8 h-8 shrink-0">
            <img
              ...
              style={{ filter: 'drop-shadow(0 2px 6px rgba(255,255,255,0.05))' }}
            />
            <div className="absolute bottom-0 right-0 w-[22%] h-[22%] bg-zinc-950" />
          </div>
          <span className="text-[11px] font-bold tracking-[0.12em] text-zinc-400">貉捷</span>
      ...
      <footer className="h-8 shrink-0 flex items-center justify-between px-5 border-t border-zinc-800/70">
        ...
        <div className="flex items-center gap-3">
          <span className="text-[10px] text-zinc-600 hidden sm:inline">@Shuang Wu 2026</span>
          <a
